...
load("envi.Rdata")
boxplot(mse.regLin,mse.tree,mse.randomForest,mse.bagging,mse.glm,mse.lasso,mse.radial.svr,optimalSmooth[2,],names=c("regLin","decisionTree","rForest","Bagging","GLM","lassoReg","SVR","GAM+SS"))
```
